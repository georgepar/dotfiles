...
globalkeys = my_table.join(
	...
	awful.key({ altkey }, "space", function()
		awful.spawn.with_shell("zsh -c 'rofi -show combi &>> /tmp/rofi.log'")
	end, {
		description = "application menu",
		group = "hotkeys",
	}),
	awful.key({ altkey, modkey1 }, "space", function()
		awful.spawn.with_shell("zsh -c 'rofi -show run &>> /tmp/rofi.log'")
	end, {
		description = "program menu",
		group = "hotkeys",
	}),
	awful.key({ altkey, modkey }, "space", function()
		awful.spawn.with_shell("rofi -show ssh &>> /tmp/rofi.log")
	end, {
	...
	awful.key({ modkey }, "m", function()
		...
		description = "Messaging apps (ferdi)",
		group = "applications",
	}),
	...
	awful.key({ modkey }, "Return", function()
		...
		description = "terminal with zsh shell",
		group = "super",
	}),
	...
	awful.key({ altkey, modkey1 }, "x", function()
		awful.prompt.run({
			prompt = "Run Lua code: ",
...
clientkeys = my_table.join(
	awful.key({ modkey, modkey1 }, "m", lain.util.magnify_client, { description = "magnify client", group = "client" }),
	awful.key({ modkey, modkey1 }, "f", function(c)

...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "p", function () awful.spawn("shutter") end,
...
clientkeys = my_table.join(
    awful.key({ modkey, modkey1   }, "m",      lain.util.magnify_client,
              {description = "magnify client", group = "client"}),
    awful.key({ modkey,  modkey1  }, "f",
        function (c)

...
globalkeys =
    ...
    awful.key(
        ...
        {description = "application menu", group = "hotkeys"}
    ),
    awful.key(
        {altkey, modkey1},
        "space",
        ...
        {description = "program menu", group = "hotkeys"}
    ),
    awful.key(
        {altkey, modkey},
        "space",
        ...
        {description = "ssh menu", group = "hotkeys"}
    ),
    -- My applications
    awful.key(
        {modkey},
    ...
    awful.key(
        ...
        {description = "Messaging apps (ferdi)", group = "applications"}
    ),
    awful.key(
        {modkey},
        "t",

...
#SBATCH --job-name=testslurm    # DO NOT FORGET TO CHANGE THIS
#SBATCH --output=testslurm.%j.out # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
#SBATCH --error=testslurm.%j.err # DO NOT FORGET TO CHANGE THIS. the job stdout will be dumped here. (%j expands to jobId).
